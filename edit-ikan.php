        ...
        <table>
            ...
            <tbody>
                ...
                while($ikan = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
                    echo "<a href='form-editikan.php?id=".$ikan['id']."' class='button-blue'>Edit</a> | ";
                    echo "<a href='hapus-ikan.php?id=".$ikan['id']."' class='button-red' onclick='return confirmDelete()'>Hapus</a>";
                    echo "</td>";
